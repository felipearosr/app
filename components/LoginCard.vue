        ...
        <form class="mt-8 space-y-3" action="#" method="POST">
          ...
          <div>
            ...
            <div class="flex justify-center pt-4">
              <div class="text-sm">
                <a href="/forgotPassword" class="font-medium text-blue-600 hover:text-blue-500">Forgot your password?</a>
              </div>
            </div>
            <div class="flex justify-center pt-4">
              <div class="text-sm">
                <p class="text-gray-700">
                  ...
                  <a href="/singUp" class="font-medium text-blue-600 hover:text-blue-500">Sign up</a>
                </p>
              </div>
            </div>
          </div>
